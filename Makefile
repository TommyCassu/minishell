SRC			= minishell.c tokenizer/tokenizer.c tokenizer/tokenizer_utils.c tokenizer/quote_checking.c tokenizer/token_manager.c parsing/parsing.c utils/utils.c parsing/cmd_manager.c parsing/clean_string.c parsing/cmd_manager_utils.c parsing/heredoc.c expansion/expansion.c exec/redirs/open_files.c exec/redirs/dup_fd.c exec/redirs/setup_redirs.c exec/pipes/pipe_utils.c exec/pipes/setup_pipes.c exec/external/find_cmd.c exec/external/exec_external.c exec/external/cmd_error.c exec/pipeline/setup_pipe_cmd.c exec/pipeline/exec_pipeline.c exec/exec_single.c exec/exec.c exec/builtin/echo.c exec/builtin/cd.c exec/builtin/is_builtin.c exec/builtin/exec_builtin.c exec/utils/ft_free_array.c exec/utils/ft_strcmp.c
